...
PanelItem::PanelItem() {
	...
	sprite_input_mass = new Sprite("img/levelmaker/input_item_mass.png");
	sprite_input_mass->clip(0, 0, sprite_input_mass->srcW(), sprite_input_mass->srcH()/2);
	button_input_mass = new Button(new Sprite("img/levelmaker/input_item_mass_button.png"));
	...
	sprite_input_elasticity = new Sprite("img/levelmaker/input_item_elasticity.png");
	sprite_input_elasticity->clip(0, 0, sprite_input_elasticity->srcW(), sprite_input_elasticity->srcH()/2);
	button_input_elasticity = new Button(new Sprite("img/levelmaker/input_item_elasticity_button.png"));
